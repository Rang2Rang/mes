<?php
	...
	for($i=0; $i<$production_data_cnt; $i++){
        ...
        // 품목 재고 등록
        $insert_sql = "INSERT INTO product_stock (company_sid, product_sid, parent_sid, type, product_change_cnt, product_stock_cnt)VALUES('".__COMPANY_SID__."', '".$product_sid."', '$production_sid', 'in', '".$production_data[$i]['production_cnt']."',$new_product_stock_cnt)";
