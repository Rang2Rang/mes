<?php
	...
	//수주 테이블 조회 (조건 :날짜)
	$sql = "SELECT order_number, order_date, account_sid FROM order_info WHERE company_sid='".__COMPANY_SID__."' AND order_date BETWEEN '$startdate' AND '$enddate' GROUP BY order_number ORDER BY order_number DESC;";
