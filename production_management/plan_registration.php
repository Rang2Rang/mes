<?php
	...
	if($is_update === true && ($_POST['plan_number']) === '' || $_POST['plan_number'] === null){
		$is_update = false;
	}
	...
	for($i=0; $i<$query_result_order_info['output_cnt']; $i++){
        ...
        $temp['order_date'] = $query_result_order_info[$i]['date'];
        ...
        $temp['order_note'] = $query_result_order_info[$i]['note'];
